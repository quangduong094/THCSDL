    ...
    <div class="bg-menu">
      <div class="wraper-content">
       ...
       <div class= ads-small> <img class ="img-right" src="h19.jpg" width="560" height="218" /> <img src="h20.jpg" width="560" height="218" /> </div>
          <div class="content-2">
            <div class ="hot-sale">
              <h2 class="title-sale">Sản Phẩm Cao Cấp</h2>
              <ul class="list-product">
                <li class="product-item">
                  <h2 class="item-name"><a href="sanpham.php?do=read&id={bc1.id}">{bc1.name}</a></h2>
                  <a href="sanpham.php?do=read&id={bc1.id}"><img src="{bc1.img}" width="244" height="246" /></a>
                  <div class="price-cart">
                    <p class="item-price"><a href="sanpham.php?do=read&id={bc1.id}">{bc1.gia}</a></p>
                    <p class="add-cart"><a href="sanpham.php?do=read&id={bc1.id}">Thêm vào giỏ</a></p>
                  </div>
                </li>
                <li class="product-item">
                  <h2 class="item-name"><a href="sanpham.php?do=read&id={bc2.id}">{bc2.name}</a></h2>
                  <a href="sanpham.php?do=read&id={bc2.id}"><img src="{bc2.img}" width="244" height="246" /></a>
                  <div class="price-cart">
                    <p class="item-price"><a href="sanpham.php?do=read&id={bc2.id}">{bc2.gia}</a></p>
                    <p class="add-cart"><a href="sanpham.php?do=read&id={bc2.id}">Thêm vào giỏ</a></p>
                  </div>
                </li>
                <li class="product-item">
                  <h2 class="item-name"><a href="sanpham.php?do=read&id={bc3.id}">{bc3.name}</a></h2>
                  <a href="sanpham.php?do=read&id={bc3.id}"><img src="{bc3.img}" width="244" height="246" /></a>
                  <div class="price-cart">
                    <p class="item-price"><a href="sanpham.php?do=read&id={bc3.id}">{bc3.gia}</a></p>
                    <p class="add-cart"><a href="sanpham.php?do=read&id={bc3.id}">Thêm vào giỏ</a></p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="content-3"> 
          	<h2 class="title-sale">Mặt hàng mới</h2>
            <ul class="typical-products">
            	<li><a href="sanpham.php?do=read&id={cn1.id}">
               		<img src="{cn1.img}" width="266" height="266" />
                    <h2 class="product-title">{cn1.name}</h2>
                    <p class="decription">
                    {cn1.ghichu}
                    </p>
                    </a>
                </li>
                <li><a href="sanpham.php?do=read&id={cn2.id}">
               		<img src="{cn2.img}" width="266" height="266" />
                    <h2 class="product-title">{cn2.name}</h2>
                    <p class="decription">
                    {cn1.ghichu}
                    </p>
                    </a>
                </li>
                <li><a href="sanpham.php?do=read&id={cn3.id}">
               		<img src="{cn3.img}" width="266" height="266" />
                    <h2 class="product-title">{cn3.name}</h2>
                    <p class="decription">
                     {cn3.ghichu}
                    </p>
                    </a>
                ...
                <li><a href="#">
               		<img src="{cn4.img}" width="266" height="266" />
                    <h2 class="product-title">{cn4.name}</h2>
                    <p class="decription">
                    {cn4.ghichu}
                    </p>
                    </a>
